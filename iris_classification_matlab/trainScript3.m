...
%Changes - experimental values: Ith=2.6e-9,tau=6.6e-6,Rp=2.25e-6
Vt = 20e-3;    % mV to V
El = -70e-3;   % mV to V
Ith = 8e-10;
tau = 1.8e-5;
Rp = 8.9e-6;
[dt, T, tauM, tauM2, tauUp, tauS, tauDn, Imax, I0, I0n, Ib, C, gL] = initVals(Ith, tau);
...
%Changing order of magnitude of tauUp to match with experimental tau (6.6e-6)
...
for i = 1:150
    ...
    [nv1,spikes1] = LIF(Iin_level1,dt,Rp,gL,C);
...
while loop>0
    ...
    prev_w1 = w1;
    %Ib = 0.7*Ib;
    [ss,failtype,failspikes,num_spikes] = test_iris3(w1,w2,level1_spikes,type,gL,C,dt,tauM,I0,I0n);
    success = [success ss];
